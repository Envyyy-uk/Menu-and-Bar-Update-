...
`seed_menu.json` зібраний із меню PODVAL: назви, ціни й варіанти взяті з
нього дослівно.

**Алергени й склад — ні.** Вони відновлені з назв продуктів, а не з листа
закладу: горіхи в амаретто, молоко у вершковому лікері, глютен у пиві. Тому
джерело всюди позначене як `reconstructed`, і гість бачить це на кожній
картці. Перед відкриттям їх має підтвердити заклад — і замінити джерело на
власний лист із датою перевірки.

Їжі в меню немає: у PDF розділ FOOD стоїть як «Coming Soon». Тому кухонний
екран лишається порожнім, поки не з'явиться харчова частина меню — станція
кухні працює, просто нікому нічого не приходить.
