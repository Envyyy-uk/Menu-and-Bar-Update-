...
**Алергенів у застосунку немає.** Заклад їх не надавав, а виведені з назв
продуктів алергени гірші за жодних: гість вірить міткам, і помилка тут
коштує дорожче за відсутність. Склад лишається — на ньому тримається пошук
трьома мовами. Гостя просять сказати про алергію бармену; так і написано в
меню.

Їжі немає: у PDF розділ FOOD стоїть як «Coming Soon». Тому кухонний екран
лишається порожнім, а перемикача станцій в інтерфейсі немає — станція кухні
жива, просто нікому нічого не приходить.
